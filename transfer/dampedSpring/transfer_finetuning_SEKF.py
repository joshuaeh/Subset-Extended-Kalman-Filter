...
if __name__ == "__main__":
    for scenario in SCENARIOS:
        ...
        if not (
            ...
            os.path.exists(os.path.join(results_dir, f"{scenario_name}_allTrials_metrics.csv")) and
            os.path.exists(os.path.join(results_dir, f"{scenario_name}_sekf_optimizer_state.npz"))
        ):
